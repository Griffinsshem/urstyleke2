    ...
    <section className="relative min-h-screen bg-black text-white flex items-center justify-center px-6 pt-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-5">
          <Link
            href="/collection"
            className="px-10 py-4 bg-white text-black font-semibold rounded-full hover:scale-105 transition"
          >
            Shop Collection
          </Link>
          ...
          <Link
            href="/about"
            className="px-10 py-4 border border-white/40 rounded-full hover:bg-white hover:text-black transition"
          >
            About
          </Link>
        </div>
