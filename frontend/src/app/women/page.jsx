  ...
  useEffect(() => {
    async function loadProducts() {
      try {
        ...
        console.error("[WomenPage] Failed to load products:", err);
          ...
          <div className="relative max-w-4xl mx-auto text-center">
            ...
            <h1
              ...
              className="
                ...
                text-[clamp(2.6rem,7vw,5rem)] text-white mb-7
              "
            >
              Women's{" "}
              <span
                style={{
                  ...
                  backgroundImage:
                    "linear-gradient(135deg,#ffffff 0%,rgba(255,255,255,0.46) 100%)",
                  backgroundClip: "text",
                }}
              >
                Collection
            ...
            <p className="reveal d3 max-w-xl mx-auto text-[0.9rem] leading-[1.78] text-white/40 tracking-wide">
              Elegance without compromise. Pieces that move with you — from
              the boardroom to the evening, always unmistakably you.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            {!loading && error && (
              <div
                role="alert"
                className="
                  max-w-md mx-auto flex items-start gap-3
                  rounded-2xl border border-red-500/20 bg-red-500/[0.08]
                  p-5 text-sm text-red-400
                "
              >
                <svg
